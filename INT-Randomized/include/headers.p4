...
const bit<6> DSCP_INT_MX = 0x17;
const bit<6> DSCP_INT_MD = 0x18;
...
// (0xFF - 3) * 4 * 8 (excluding INT shim header and INT header)
header int_data_t {
    varbit<8064> data;
}
...
struct headers {
    ...
    int_level1_port_ids_t       rep_level1_port_ids;
    int_hop_latency_t           rep_hop_latency;
    int_q_occupancy_t           rep_q_occupancy;
    int_ingress_tstamp_t        rep_ingress_tstamp;
    int_egress_tstamp_t         rep_egress_tstamp;
    int_level2_port_ids_t       rep_level2_port_ids;
    int_egress_port_tx_util_t   rep_egress_tx_util;
}
...
struct local_metadata_t {
    ...
    preserving_metadata_t preserv_meta;
}